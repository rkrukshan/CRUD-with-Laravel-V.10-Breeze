                        ...
                        <tr>
                          <td class="border border-slate-700 text-white ">{{ $student->id }}</td>
                           ...
                           <td class="border border-slate-700 text-white">
                              <a href="{{ url('/edit-student/'.$student->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</a>
                           <a href="{{ url('/') }}" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Delete</a>
                          </td>
                       </tr>
                        @empty
