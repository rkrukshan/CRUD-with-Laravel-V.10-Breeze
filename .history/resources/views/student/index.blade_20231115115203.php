                ...
                <tr>
                  <td class="border border-slate-700 text-white ">{{ $record->id }}</td>
                   ...
                   <td class="border border-slate-700 text-white">
                      <a hr class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</a>
                   <a hr class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Delete</a>
                  </td>
               </tr>
                @empty
