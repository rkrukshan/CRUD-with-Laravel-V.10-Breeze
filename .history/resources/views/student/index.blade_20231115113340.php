...
<center>
    <table class="hover:table-fixed">
        <tr>
            <th widt class="border border-slate-700 text-white ">ID</th>
            <th widt class="border border-slate-700 text-white ">Name</th>
            <th widt class="border border-slate-700 text-white ">Email</th>
            <th widt class="border border-slate-700 text-white ">Phone</th>
            <th widt class="border border-slate-700 text-white ">Action</th>
        </tr>
        <tbody>
