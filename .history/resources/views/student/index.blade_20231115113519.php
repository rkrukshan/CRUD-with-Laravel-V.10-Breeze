...
<center>
    <table class="hover:table-fixed">
        <tr>
            <th width=100 class="border border-slate-700 text-white ">ID</th>
            <th width=100 class="border border-slate-700 text-white ">Name</th>
            <th width=100 class="border border-slate-700 text-white ">Email</th>
            <th width=100 class="border border-slate-700 text-white ">Phone</th>
            <th width=100 class="border border-slate-700 text-white ">Action</th>
        </tr>
        <tbody>
