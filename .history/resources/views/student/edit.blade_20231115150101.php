                    ...
                    <form action="{{ url('update-student/'.$students->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="name" name="name"
                                :value="$students->name autofocus autocomplete="username" />
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                                :value="$students->email" autofocus autocomplete="username" />
                        ...
                        <div>
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="phone" name="phone"
                                :value="$students->phone" autofocus autocomplete="username" />
