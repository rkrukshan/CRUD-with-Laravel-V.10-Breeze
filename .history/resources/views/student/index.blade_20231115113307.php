...
<center>
    <table class="hover:table-fixed">
        <tr>
            <th class="border border-slate-700 text-white ">ID</th>
            <th class="border border-slate-700 text-white ">Name</th>
            <th class="border border-slate-700 text-white ">Email</th>
            <th class="border border-slate-700 text-white ">Phone</th>
            <th class="border border-slate-700 text-white ">Action</th>
        </tr>
        <tbody>
